...
🎯 **Goal:** Learn how to move the box by calling functions in the `update` function (lines 78-83 in index.html).

---

### Step-by-Step Instructions

1. **🔍 Locate the `update` function declaration** (around line 78 in the index.html file)
